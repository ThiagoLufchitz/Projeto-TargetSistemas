...
from questao1 import calcularsoma
from questao2 import nFibonacci
from questao3 import processandooFaturamento
from questao4 import calcularPercentage
from questao5 import inverterString

def main():
    while True:
        print("\nEscolha o número do problema a ser executado:")
        ...
        try:
            ...
            if escolha == "1":
               calcularsoma()
                ...
                print("Escolha inválida. Digite um valor valido.")
